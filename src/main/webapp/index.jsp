...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo">CCUTCloudExam</a>
            <!-- 显示/隐藏菜单 -->
            ...
            <ul class="layui-nav topLevelMenus" pc>
                ...
                <!-- 教师中心 -->
                <li class="layui-nav-item" data-menu="teacher" pc>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2018 CCUT Cloud Exam Manager : author internet</span>　　</p>
    </div>
</div>
